...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="card" style="margin: 60px">
        <div class="card-body">
          <h5 class="card-title">Ads Create Data Form</h5>

          <!-- Vertical Form -->
          <form class="row g-3" action="{{route("Ads.store")}}" method="POST" enctype="multipart/form-data">
            @csrf
          ...
          <a href="{{route("Ads.index")}}" class="btn btn-primary btn-icon-split" >
            <span class="icon text-white-50">
