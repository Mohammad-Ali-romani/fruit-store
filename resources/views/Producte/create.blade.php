...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="card" style="margin: 60px">
        <div class="card-body">
          ...
          <!-- Vertical Form -->
          <form class="row g-3" action="{{route("Producte.store")}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-12" style="margin: 10px">
                ...
                <input type="text" name="evaluation" class="form-control" id="evaluation">
              </div>
            <div class="col-12" style="margin: 10px">
