...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="card" style="margin: 60px">
        <div class="card-body">
          ...
          <!-- Vertical Form -->
          <form class="row g-3" action="{{route("Meta.update",$meta->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12" style="margin: 10px">
              <label for="name" class="form-label">Name</label>
              <input type="text" name="name" class="form-control" id="name" value="{{$meta->name}}">
            </div>
            <div class="col-12" style="margin: 10px">
                <label for="value" class="form-label">Value</label>
                <input type="text" name="value" class="form-control" id="value" value="{{$meta->value}}">
              </div>
