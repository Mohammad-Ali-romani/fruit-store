...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="card" style="margin: 60px">
        <div class="card-body">
          <h5 class="card-title">Setting Create Data Form</h5>

          <!-- Vertical Form -->
          <form class="row g-3" action="{{route("Setting.store",$setting->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12" style="margin: 10px">
              <label for="logo" class="form-label">Logo</label>
              <input type="text" name="logo" class="form-control" id="logo" value="{{$setting->logo}}">
            </div>
            <div class="col-12" style="margin: 10px">
                <label for="title" class="form-label">Title</label>
                <input type="text" name="title" class="form-control" id="title" value="{{$setting->logo}}">
              </div>
            <div class="col-12" style="margin: 10px">
                <label for="desc" class="form-label">Description</label>
                <input type="text" name="desc" class="form-control" id="desc" value="{{$setting->logo}}">
              </div>
             <div class="col-12">
