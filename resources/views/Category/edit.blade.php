...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="card" style="margin: 60px">
        <div class="card-body">
          <h5 class="card-title">Category Create Data Form</h5>

          <!-- Vertical Form -->
          <form class="row g-3" action="{{route("Category.store",$category->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="col-12" style="margin: 10px">
                ...
                <input type="text" name="calor" class="form-control" id="calor" value="{{$category->calor}}">
              </div>
          ...
          <a href="{{route("Category.index")}}" class="btn btn-primary btn-icon-split" >
            <span class="icon text-white-50">
