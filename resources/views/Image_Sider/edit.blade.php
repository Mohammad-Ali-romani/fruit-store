...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="card" style="margin: 60px">
        <div class="card-body">
          <h5 class="card-title">Image Slider Create Data Form</h5>

          <!-- Vertical Form -->
          <form class="row g-3" action="{{route("Image_Sider.update",$sider->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12" style="margin: 10px">
              <label for="url" class="form-label">Url</label>
              <input type="text" name="url" class="form-control" id="url" value="{{$sider->url}}">
            </div>
          ...
          <a href="{{route("Image_Sider.index")}}" class="btn btn-primary btn-icon-split" >
            <span class="icon text-white-50">
